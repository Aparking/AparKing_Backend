...
urlpatterns = [
    ...
    path("<int:pk>/images/", views.get_images_by_garage_id, name="get_images_by_garage_id",),
    path("<int:pk>/availability/", views.get_availabilities_by_garage_id, name="get_availabilities_by_garage_id",),
    ...
    path("availability/<int:pk>/", views.availability_detail, name="update_availability"),
